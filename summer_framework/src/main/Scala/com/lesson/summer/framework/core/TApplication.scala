...
import com.lesson.summer.framework.util.{EnvUtil, PropertiesUtil}
...
trait TApplication {
  /*
    开发原则:OCP  Open-Close原则
    Open: 开发的程序代码应该对功能进行扩展
    Close: 在扩展的同时不该对原有的代码进行修改
   */
